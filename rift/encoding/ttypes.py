...
class PacketHeader(object):
    ...
    def __init__(self, major_version=8, minor_version=0, sender=None, level=None,):
...
class Neighbor(object):
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.I64:
                    originator = iprot.readI64()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.I32:
                    remote_id = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class NodeCapabilities(object):
    ...
    def __init__(self, protocol_minor_version=0, flood_reduction=True, hierarchy_indications=None, auto_evpn_support=False, auto_flood_reflection_support=False,):
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if fid == 1:
                if ftype == TType.I16:
                    protocol_minor_version = iprot.readI16()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.BOOL:
                    flood_reduction = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.I32:
                    hierarchy_indications = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.BOOL:
                    auto_evpn_support = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 20:
                if ftype == TType.BOOL:
                    auto_flood_reflection_support = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
        ...
        return cls(
            ...
            hierarchy_indications=hierarchy_indications,
            auto_evpn_support=auto_evpn_support,
            auto_flood_reflection_support=auto_flood_reflection_support,
        )
...
class LinkCapabilities(object):
    ...
    def __init__(self, bfd=True, ipv4_forwarding_capable=True,):
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.BOOL:
                    ipv4_forwarding_capable = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
        ...
        return cls(
            bfd=bfd,
            ipv4_forwarding_capable=ipv4_forwarding_capable,
        )
...
class LIEPacket(object):
    ...
    Attributes:
     ...
     - link_mtu_size: Layer 2 MTU, used to discover mismatch.
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.instance_name = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 35:
                if ftype == TType.I16:
...
class LinkIDPair(object):
    ...
    def read(cls, iprot):
        ...
        local_id = None
        remote_id = None
        platform_interface_index = None
        platform_interface_name = None
        trusted_outer_security_key = None
        bfd_up = None
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    platform_interface_index = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 11:
                if ftype == TType.STRING:
                    platform_interface_name = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                if ftype == TType.BYTE:
                    trusted_outer_security_key = iprot.readByte()
                else:
                    iprot.skip(ftype)
            elif fid == 13:
                if ftype == TType.BOOL:
                    bfd_up = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 14:
                if ftype == TType.SET:
                    ...
                    for _i4 in range(_size0):
                        ...
                        address_families.add(_elem5)
                    iprot.readSetEnd()
                    address_families = frozenset(address_families)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
        ...
        return cls(
            local_id=local_id,
            remote_id=remote_id,
            platform_interface_index=platform_interface_index,
            platform_interface_name=platform_interface_name,
...
class TIEID(object):
    ...
    Attributes:
     ...
     - originator: Indicates originator of  TIE.
     - tietype: Type of  TIE.
     - tie_nr: Number of TIE.
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    tietype = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.I32:
                    tie_nr = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
...
class TIEHeader(object):
    ...
    Attributes:
     - tieid: ID of  TIE.
     - seq_nr: Sequence number of  TIE.
     - origination_time: Absolute timestamp when TIE was generated.
     - origination_lifetime: Original lifetime when TIE was generated.
...
class NodeNeighborsTIEElement(object):
    ...
    Attributes:
     ...
     - cost: Cost to neighbor. Ignore anything equal or larger than `infinite_distance` and equal to `invalid_distance`.
     - link_ids: Carries description of multiple parallel links in a TIE.
     - bandwidth: Total bandwith to neighbor as sum of all parallel links.

    """


    def __init__(self, level=None, cost=1, link_ids=None, bandwidth=100,):
...
class NodeFlags(object):
    ...
    def __init__(self, overload=False, acting_auto_evpn_dci_when_tof=False,):
    ...
    def read(cls, iprot):
        ...
        iprot.readStructBegin()
        overload = False
        acting_auto_evpn_dci_when_tof = False
        while True:
            (fname, ftype, fid) = iprot.readFieldBegin()
            if ftype == TType.STOP:
                break
            if fid == 1:
                if ftype == TType.BOOL:
                    overload = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.BOOL:
                    acting_auto_evpn_dci_when_tof = iprot.readBool()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
        ...
        return cls(
            overload=overload,
            acting_auto_evpn_dci_when_tof=acting_auto_evpn_dci_when_tof,
        )
...
class NodeTIEElement(object):
    ...
    def __init__(self, level=None, neighbors=None, capabilities=None, flags=None, name=None, pod=None, startup_time=None, miscabled_links=None, same_plane_tofs=None, fabric_id=1, auto_evpn_version=None, auto_evpn_model=0, auto_flood_reflection_version=None, auto_flood_reflection_cluster_id=None, auto_flood_reflection_preference=None,):
    ...
    def read(cls, iprot):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i32 in range(_size28):
                        ...
                        neighbors[_key33] = _val34
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRUCT:
                    capabilities = NodeCapabilities.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 4:
                if ftype == TType.STRUCT:
                    flags = NodeFlags.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRING:
                ...
                if ftype == TType.SET:
                    ...
                    for _i39 in range(_size35):
                        ...
                        miscabled_links.add(_elem40)
                    iprot.readSetEnd()
                    miscabled_links = frozenset(miscabled_links)
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                if ftype == TType.SET:
                    ...
                    for _i45 in range(_size41):
                        ...
                        same_plane_tofs.add(_elem46)
                    iprot.readSetEnd()
                    same_plane_tofs = frozenset(same_plane_tofs)
                else:
                    iprot.skip(ftype)
            elif fid == 20:
                if ftype == TType.I16:
                    fabric_id = iprot.readI16()
                else:
                    iprot.skip(ftype)
            elif fid == 21:
                if ftype == TType.I16:
                    auto_evpn_version = iprot.readI16()
                else:
                    iprot.skip(ftype)
            elif fid == 25:
                if ftype == TType.I32:
                    auto_evpn_model = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 30:
                if ftype == TType.I16:
                    auto_flood_reflection_version = iprot.readI16()
                else:
                    iprot.skip(ftype)
            elif fid == 31:
                if ftype == TType.I32:
                    auto_flood_reflection_cluster_id = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 32:
                if ftype == TType.I32:
                    auto_flood_reflection_preference = iprot.readI32()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
        ...
        return cls(
            ...
            fabric_id=fabric_id,
            auto_evpn_version=auto_evpn_version,
            auto_evpn_model=auto_evpn_model,
            auto_flood_reflection_version=auto_flood_reflection_version,
            auto_flood_reflection_cluster_id=auto_flood_reflection_cluster_id,
            auto_flood_reflection_preference=auto_flood_reflection_preference,
        )
...
class PrefixAttributes(object):
    ...
    def __init__(self, metric=1, tags=None, monotonic_clock=None, loopback=False, directly_attached=True, from_link=None, label=None,):
    ...
    def read(cls, iprot):
        ...
        while True:
            ...
            if fid == 2:
                ...
                if ftype == TType.STRUCT:
                    ...
                    monotonic_clock.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.BOOL:
                    loopback = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.BOOL:
                    directly_attached = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 10:
                if ftype == TType.I32:
                    from_link = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 12:
                if ftype == TType.I32:
        ...
        return cls(
            ...
            loopback=loopback,
            directly_attached=directly_attached,
            from_link=from_link,
            label=label,
        )
...
class KeyValueTIEElementContent(object):
    ...
    def __init__(self, targets=0, value=None,):
...
class TIEElement(object):
    ...
    def read(cls, iprot):
        ...
        positive_external_disaggregation_prefixes = None
        keyvalues = None
        while True:
            (fname, ftype, fid) = iprot.readFieldBegin()
            if ftype == TType.STOP:
            ...
            if fid == 1:
                if ftype == TType.STRUCT:
                    node = NodeTIEElement.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.STRUCT:
                    prefixes = PrefixTIEElement.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRUCT:
                    positive_disaggregation_prefixes = PrefixTIEElement.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRUCT:
                    negative_disaggregation_prefixes = PrefixTIEElement.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.STRUCT:
                    external_prefixes = PrefixTIEElement.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.STRUCT:
                    positive_external_disaggregation_prefixes = PrefixTIEElement.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 9:
                if ftype == TType.STRUCT:
                    keyvalues = KeyValueTIEElement.read(iprot)
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
        ...
        return cls(
            node=node,
            prefixes=prefixes,
            positive_disaggregation_prefixes=positive_disaggregation_prefixes,
            negative_disaggregation_prefixes=negative_disaggregation_prefixes,
...
class ProtocolPacket(object):
    ...
    def __ne__(self, other):
        return not (self == other)
all_structs.append(PacketHeader)
PacketHeader.thrift_spec = (
    None,  # 0
...
all_structs.append(Community)
Community.thrift_spec = (
    None,  # 0
    (1, TType.I32, 'top', None, None, ),  # 1
    (2, TType.I32, 'bottom', None, None, ),  # 2
)
all_structs.append(Neighbor)
Neighbor.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'originator', None, None, ),  # 1
    (2, TType.I32, 'remote_id', None, None, ),  # 2
)
all_structs.append(NodeCapabilities)
NodeCapabilities.thrift_spec = (
    None,  # 0
...
all_structs.append(LinkCapabilities)
LinkCapabilities.thrift_spec = (
    None,  # 0
    (1, TType.BOOL, 'bfd', None, True, ),  # 1
    (2, TType.BOOL, 'ipv4_forwarding_capable', None, True, ),  # 2
)
all_structs.append(LIEPacket)
LIEPacket.thrift_spec = (
    None,  # 0
    ...
    (6, TType.STRUCT, 'neighbor', [Neighbor, None], None, ),  # 6
    (7, TType.I32, 'pod', None, 0, ),  # 7
    None,  # 8
    None,  # 9
    (10, TType.STRUCT, 'node_capabilities', [NodeCapabilities, None], None, ),  # 10
    (11, TType.STRUCT, 'link_capabilities', [LinkCapabilities, None], None, ),  # 11
...
all_structs.append(LinkIDPair)
LinkIDPair.thrift_spec = (
    None,  # 0
...
all_structs.append(TIEHeader)
TIEHeader.thrift_spec = (
    None,  # 0
    None,  # 1
    (2, TType.STRUCT, 'tieid', [TIEID, None], None, ),  # 2
    ...
    None,  # 8
    None,  # 9
    (10, TType.STRUCT, 'origination_time', [common.ttypes.IEEE802_1ASTimeStampType, None], None, ),  # 10
    None,  # 11
    (12, TType.I32, 'origination_lifetime', None, None, ),  # 12
)
all_structs.append(TIEHeaderWithLifeTime)
TIEHeaderWithLifeTime.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'header', [TIEHeader, None], None, ),  # 1
    (2, TType.I32, 'remaining_lifetime', None, None, ),  # 2
)
all_structs.append(TIDEPacket)
TIDEPacket.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'start_range', [TIEID, None], None, ),  # 1
    (2, TType.STRUCT, 'end_range', [TIEID, None], None, ),  # 2
    (3, TType.LIST, 'headers', (TType.STRUCT, [TIEHeaderWithLifeTime, None], True), None, ),  # 3
)
all_structs.append(TIREPacket)
TIREPacket.thrift_spec = (
    None,  # 0
    (1, TType.SET, 'headers', (TType.STRUCT, [TIEHeaderWithLifeTime, None], True), None, ),  # 1
)
all_structs.append(NodeNeighborsTIEElement)
NodeNeighborsTIEElement.thrift_spec = (
    None,  # 0
    (1, TType.BYTE, 'level', None, None, ),  # 1
    None,  # 2
    (3, TType.I32, 'cost', None, 1, ),  # 3
    (4, TType.SET, 'link_ids', (TType.STRUCT, [LinkIDPair, None], True), None, ),  # 4
    (5, TType.I32, 'bandwidth', None, 100, ),  # 5
)
all_structs.append(NodeFlags)
NodeFlags.thrift_spec = (
    None,  # 0
...
all_structs.append(NodeTIEElement)
NodeTIEElement.thrift_spec = (
    None,  # 0
    (1, TType.BYTE, 'level', None, None, ),  # 1
    (2, TType.MAP, 'neighbors', (TType.I64, None, TType.STRUCT, [NodeNeighborsTIEElement, None], False), None, ),  # 2
    (3, TType.STRUCT, 'capabilities', [NodeCapabilities, None], None, ),  # 3
    (4, TType.STRUCT, 'flags', [NodeFlags, None], None, ),  # 4
...
all_structs.append(PrefixAttributes)
PrefixAttributes.thrift_spec = (
    None,  # 0
    None,  # 1
    (2, TType.I32, 'metric', None, 1, ),  # 2
    (3, TType.SET, 'tags', (TType.I64, None, True), None, ),  # 3
    (4, TType.STRUCT, 'monotonic_clock', [common.ttypes.PrefixSequenceType, None], None, ),  # 4
    None,  # 5
...
all_structs.append(PrefixTIEElement)
PrefixTIEElement.thrift_spec = (
    None,  # 0
    (1, TType.MAP, 'prefixes', (TType.STRUCT, [common.ttypes.IPPrefixType, None], TType.STRUCT, [PrefixAttributes, None], False), None, ),  # 1
)
all_structs.append(KeyValueTIEElementContent)
KeyValueTIEElementContent.thrift_spec = (
    None,  # 0
    (1, TType.I64, 'targets', None, 0, ),  # 1
    (2, TType.STRING, 'value', 'BINARY', None, ),  # 2
)
all_structs.append(KeyValueTIEElement)
KeyValueTIEElement.thrift_spec = (
    None,  # 0
    (1, TType.MAP, 'keyvalues', (TType.I32, None, TType.STRUCT, [KeyValueTIEElementContent, None], False), None, ),  # 1
)
all_structs.append(TIEElement)
TIEElement.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'node', [NodeTIEElement, None], None, ),  # 1
    (2, TType.STRUCT, 'prefixes', [PrefixTIEElement, None], None, ),  # 2
    (3, TType.STRUCT, 'positive_disaggregation_prefixes', [PrefixTIEElement, None], None, ),  # 3
    None,  # 4
    (5, TType.STRUCT, 'negative_disaggregation_prefixes', [PrefixTIEElement, None], None, ),  # 5
    (6, TType.STRUCT, 'external_prefixes', [PrefixTIEElement, None], None, ),  # 6
    (7, TType.STRUCT, 'positive_external_disaggregation_prefixes', [PrefixTIEElement, None], None, ),  # 7
    None,  # 8
    (9, TType.STRUCT, 'keyvalues', [KeyValueTIEElement, None], None, ),  # 9
)
all_structs.append(TIEPacket)
TIEPacket.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'header', [TIEHeader, None], None, ),  # 1
    (2, TType.STRUCT, 'element', [TIEElement, None], None, ),  # 2
)
all_structs.append(PacketContent)
PacketContent.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'lie', [LIEPacket, None], None, ),  # 1
    (2, TType.STRUCT, 'tide', [TIDEPacket, None], None, ),  # 2
    (3, TType.STRUCT, 'tire', [TIREPacket, None], None, ),  # 3
    (4, TType.STRUCT, 'tie', [TIEPacket, None], None, ),  # 4
)
all_structs.append(ProtocolPacket)
ProtocolPacket.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'header', [PacketHeader, None], None, ),  # 1
    (2, TType.STRUCT, 'content', [PacketContent, None], None, ),  # 2
)
